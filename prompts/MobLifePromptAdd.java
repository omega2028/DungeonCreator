...
public class MobLifePromptAdd extends StringPrompt {
    @Override
    ...
    public @Nullable Prompt acceptInput(@NotNull ConversationContext context, @Nullable String input) {
        ...
        try {
            ...
            return new MobLifePromptAdd();//On redemande
        }
        Dungeoncreator.getInstance().getCustomMobController().getMobTmp().setHealth(pv);
